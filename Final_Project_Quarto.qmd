...
```
The present report uses the "Educational attainment of young people in English towns" data set provided by the UK Office of National Statistics. The data set collected information based on students who took their GCSEs between 2012 and 2013, including educational attainment from primary school years until age 22. @tbl-sample shows a small sample of the data that was collected.  
...
)|> modify_caption("**Table 3: Linear Regression Model**")
