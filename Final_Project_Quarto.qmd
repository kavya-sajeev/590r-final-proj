...
uksample<-read_csv(here::here("data","Data Sample.csv"))
```
The present report uses the "Educational attainment of young people in English towns" data set provided by the UK Office of National Statistics. The data set collected information based on students who took their GCSEs between 2012 and 2013. @tbl-sample shows a sample of the data that was collected.  

```{r}
#| label: tbl-sample
#| tbl-cap: "Sample of data collected"
knitr::kable(uksample, knitr.kable.NA = '')
```
...
#| label:fig-pop-hist
#| fig-cap: "Histogram of Education Score"

hist(uk$education_score,
		 main = "Distribution of Education Score",
...
)|> modify_caption("**Table 3: Linear Regression**")
