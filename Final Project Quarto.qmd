...
```
Descriptive statistics of the cohort are depicted above (@tbl-descriptive). (`r coastaldep`) percent of the coastal towns are higher deprivation towns, while `r noncoastaldep` percent of non-coastal towns are higher deprivation. The median education score of the cohort is `r stats$median_edu`. 
```{r}
#figure
